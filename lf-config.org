...
#+begin_src emacs-lisp
  (use-package consult
    ...
    (
     ...
     ("M-º" . consult-register-load)
     ("M-ª" . consult-register-store)          ;; orig. abbrev-prefix-mark (unrelated)
     ("C-M-º" . consult-register)
...
#+end_src
** Ruby
Required Ruby gems (you already have these installed):
#+begin_example
gem install solargraph rubocop
# OR use ruby-lsp instead of solargraph:
# gem install ruby-lsp
#+end_example

#+begin_src emacs-lisp
  ;; Ruby base configuration
  (use-package ruby-mode
    ...
    (ruby-deep-indent-paren nil)        ; Don't over-indent parameters
    (ruby-deep-indent-paren-style nil)  ; Align to first parameter
    (ruby-after-operator-indent t)      ; Indent after operators
    (ruby-method-params-indent 0)       ; Method params indent offset
    (ruby-block-indent t)               ; Indent block contents
    :config
    ;; Don't insert encoding comment
    (setq ruby-insert-encoding-magic-comment nil)

    ;; Tree-sitter indentation for ruby-ts-mode
  ...
  ;; Eglot configuration for Ruby LSP
  (with-eval-after-load 'eglot
    ;; Solargraph configuration (default)
    (add-to-list 'eglot-server-programs
                 '((ruby-mode ruby-ts-mode) . ("solargraph" "stdio")))

    ;; Alternative: Use ruby-lsp instead of solargraph
    ;; Uncomment these lines and comment out the solargraph line above:
    ;; (add-to-list 'eglot-server-programs
    ;;              '((ruby-mode ruby-ts-mode) . ("ruby-lsp")))

    ;; Solargraph workspace configuration
    (setq-default eglot-workspace-configuration
                  (append (default-value 'eglot-workspace-configuration)
                          '(:solargraph
                            (:diagnostics t
                             :formatting t
                             :useBundler :json-false
                             :completion t
                             :hover t
                             :symbols t
                             :definitions t
  ...
  ;; Ruby mode hooks for better development experience
...
#+begin_src emacs-lisp
  (use-package org-appear
    ...
    (org-appear-autoentities t)      ;; Show entity markers \alpha -> α
